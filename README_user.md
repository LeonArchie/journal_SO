Изменения в релизе v.5.0.0
    Добавлен скрипт GIS_to_exel.py который автоматически создает форматрирование и конвертирование CSV в xlsx
    Убрана проверка ERROR из скрипта управления 
    Убрано длительно ожидание проверок
